...
<h1>Background Colors</h1>
	 ...
	 <br>
 	 ...
 	 <tr> 
        <th scope='row'><?php _e('Font Family For Headings','ultimate-landing-page');?></th>
    ...
    <tr> 
        <th scope='row'><?php _e('Font Family For Paragraphs','ultimate-landing-page');?></th>
    ...
    <tr> 
        <th scope='row'><?php _e('Font Family For Input Fields','ultimate-landing-page');?></th>
